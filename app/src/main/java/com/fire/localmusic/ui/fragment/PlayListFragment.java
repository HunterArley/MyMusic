...
import com.fire.localmusic.adapter.PlayListAdapter;
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemLongClick(View view, int position) {
                ...
                if(!TextUtils.isEmpty(name)) {
                    mMultiChoice.itemAddorRemoveWithLongClick(view, position,
                            getPlayListId(position), TAG, Constants.PLAYLIST);
                }
            }
        });
    }
