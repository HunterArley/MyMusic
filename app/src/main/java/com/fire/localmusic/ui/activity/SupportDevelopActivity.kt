...
import com.fire.localmusic.adapter.PurchaseAdapter
import com.fire.localmusic.bean.PurchaseBean
...
import com.fire.localmusic.util.AlipayUtil
                ...
                when(position){
                    ...
                    1 -> {
                        MaterialDialog.Builder(mContext)
                                ...
                                .onPositive { _, _ -> AlipayUtil.startAlipayClient(mContext as Activity, "FKX09603UIELJZGF1HOME3") }
