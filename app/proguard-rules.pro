...
#baseAdapter
-keepclassmembers class com.fire.localmusic.adapter.holder.BaseViewHolder
-keepclasseswithmembers class com.fire.localmusic.adapter.holder.BaseViewHolder {
    <fields>;
    <methods>;
}
-keepclasseswithmembers class * extends com.fire.localmusic.adapter.holder.BaseViewHolder{
    <fields>;
    <methods>;
}

-keep class **.R$* {*;}
-keep public class com.fire.localmusic.R$*{
